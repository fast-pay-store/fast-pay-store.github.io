// Запускаем наш код только после того, как весь сайт Gamma полностью загрузился на экране
window.addEventListener('load', function() {
    
    // 1. Безопасно создаем канонический тег в самом конце загрузки страницы
